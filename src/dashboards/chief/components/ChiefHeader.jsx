  ...
  return (
    <header className="site-header" role="banner">
      <div className="site-header__inner">
        ...
        <Link className="brand" to="/chief/dashboard" aria-label="Chief portal home">
          <div className="brand__mark brand__mark--chief" aria-hidden="true">
            C
          </div>
          <span className="brand__word">
            MCA <span className="brand__portal">Chief portal</span>
            {chiefName ? (
              <span className="brand__chief-name">{chiefName}</span>
            ) : null}
          </span>
        </Link>
        ...
        <div className="header-actions">
          ...
          {showProfile ? (
            <Link className="header-avatar header-avatar--chief" to="/chief/profile" aria-label="Open profile">
